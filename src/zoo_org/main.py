...
from org_unit.database import DB_PATH, init_db
from org_unit.routers import assignments, org_units, persons
...
def create_app() -> FastAPI:
    app = FastAPI(
        title="Org_Unit",
        description="Organizational structure of a juristical person",
        version="0.1.0",
        lifespan=lifespan,
    )
